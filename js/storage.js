...
const SEED_SERVICES = [
  {
    ...
    duracao: "3 horas",
    descricao:
      "Serviço completo de maquilhagem para noivas, incluindo prova prévia. Realço a tua beleza natural para o dia mais especial da tua vida, garantindo uma maquilhagem duradoura e fotogénica.",
    imagemUrl:
  ...
  },
  {
    ...
    duracao: "1.5 horas",
    descricao:
      "Maquilhagem profissional para eventos sociais, festas, jantares especiais ou qualquer ocasião que mereça um look impecável.",
    imagemUrl:
  ...
  },
  {
    ...
    duracao: "2 horas",
    descricao:
      "Maquilhagem artística e profissional especialmente preparada para sessões fotográficas, editoriais e portfolios.",
    imagemUrl:
...
const SEED_WORKSHOPS = [
  {
    ...
    preco: 150,
    descricao:
      "Aprende as técnicas essenciais para te maquilhares como uma profissional. Inclui kit de pincéis.",
    imagemUrl:
      "https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=400",
    vagas: 10,
    observacoes:
      "Material incluído. Turmas reduzidas para maior atenção individual.",
    ativo: true,
    createdAt: getCurrentDateTime(),
  },
  {
    ...
    preco: 1200,
    descricao:
      "Formação completa certificada para quem quer iniciar carreira como maquilhador profissional.",
    imagemUrl:
...
const SEED_EVENTS = [
  {
    ...
    vagas: 20,
    descricao:
      "Evento exclusivo onde apresento as principais tendências de maquilhagem para 2025. Demonstrações ao vivo e networking.",
    imagemUrl:
  ...
  },
  {
    ...
    vagas: 50,
    descricao:
      "Evento de lançamento da nova coleção de pincéis profissionais. Coquetel e demonstrações exclusivas.",
    imagemUrl:
      "https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=400",
    preco: 0,
    ativo: true,
  ...
  },
  {
    ...
    vagas: 15,
    descricao:
      "Workshop intensivo sobre maquilhagem de noivas num cenário deslumbrante no Douro. Inclui almoço.",
    imagemUrl:
...
const SEED_PRODUCTS = [
  {
    ...
    descricao:
      "Kit completo com 12 pincéis profissionais de alta qualidade. Cerdas sintéticas veganas.",
    estoque: 25,
    ativo: true,
    createdAt: getCurrentDateTime(),
  },
  {
    ...
    descricao:
      "Paleta com 18 tons nude e neutros. Acabamentos matte, shimmer e glitter.",
    estoque: 40,
    ativo: true,
    createdAt: getCurrentDateTime(),
  },
  {
    ...
    descricao:
      "Base de alta definição com cobertura média a alta. Acabamento natural e longa duração.",
    estoque: 60,
    ativo: true,
    createdAt: getCurrentDateTime(),
  },
  {
    ...
    descricao:
      "Batom líquido de longa duração com acabamento matte aveludado. Não resseca os lábios.",
    estoque: 80,
    ativo: true,
    createdAt: getCurrentDateTime(),
  },
  {
    ...
    descricao:
      "Primer com partículas iluminadoras para uma pele radiante e preparada para maquilhagem.",
    estoque: 35,
    ativo: true,
    createdAt: getCurrentDateTime(),
  },
  {
    ...
    categoria: "Olhos",
    imagemUrl:
      "https://images.unsplash.com/photo-1631214500115-598fc2cb8d2a?w=400",
    descricao:
      "Máscara volumizadora à prova de água. Escova curvada para efeito leque.",
    estoque: 50,
    ativo: true,
    createdAt: getCurrentDateTime(),
  },
  {
    ...
    descricao:
      "Paleta de contorno em creme com 4 tons para esculpir e iluminar o rosto.",
    estoque: 30,
    ativo: true,
    createdAt: getCurrentDateTime(),
  },
  {
    ...
    descricao:
      "Spray fixador de longa duração. Mantém a maquilhagem intacta até 16 horas.",
    estoque: 45,
    ativo: true,
    createdAt: getCurrentDateTime(),
  },
...
function initializeSeed() {
  ...
  if (!existingUsers || existingUsers.length === 0) {
    ...
    const adminExists = existingUsers.find(
      (u) => u.email === "admin@yemarmakeup.pt" && u.senha === "admin123",
    );
    if (!adminExists) {
  ...
  if (!getData("siteSettings")) {
    ...
    if (!currentSettings.formacaoAcademica) {
      currentSettings.formacaoAcademica =
        SEED_SITE_SETTINGS.formacaoAcademica || [];
      setData("siteSettings", currentSettings);
    }
    if (!currentSettings.certificacoesTextuais) {
      currentSettings.certificacoesTextuais =
        SEED_SITE_SETTINGS.certificacoesTextuais || [];
      setData("siteSettings", currentSettings);
    }
  }
  if (!getData("cart")) {
...
function searchAll(query) {
  ...
  // Pesquisar serviços
  results.services = getActiveServices().filter(
    (s) =>
      s.nome.toLowerCase().includes(q) || s.descricao.toLowerCase().includes(q),
  );

  // Pesquisar workshops
  results.workshops = getActiveWorkshops().filter(
    (w) =>
  ...
  // Pesquisar produtos
  results.products = getActiveProducts().filter(
    (p) =>
  ...
  // Pesquisar posts
  results.posts = getActivePosts().filter(
    (p) =>
  ...
  // Pesquisar eventos
  results.events = getActiveEvents().filter(
    (e) =>
